...
<div class='wrapper'>
    ...
    <?php
    $game = "Garena Fire Free";
    $games = R::getAll('SELECT * FROM tournaments WHERE game = :game AND data > :time_only', [':game' => $game, 'time_only' => time()]);
    ...
    if ($games) :
                    ...
                    <div class='games'>
                        ...
                        foreach ($items as $item) :
                            ...
                            <div class='game game-type'>
                                <div class='area-1'>
                                    <div class='game-image' style="background-image:url(<?php echo $item['img'] ?>);"></div>
        ...
        <?php
        $tomorrow = R::getAll('SELECT * FROM tournaments WHERE game = :game AND data < :date_24hour and data > :time_only ORDER BY data ASC', [':game' => $game, ':date_24hour' => time()+86400, 'time_only' => time()+3600]);
        if($tomorrow) :
            ?>
    ...
    <?php else : ?>
        ...
        <div style="text-align: center;margin-top: 60px;">
            <h2 style="font-size: 18px; opacity: 0.7">Список турниров пока пуст :( <br>Зайдите позже</h2>
        </div>
